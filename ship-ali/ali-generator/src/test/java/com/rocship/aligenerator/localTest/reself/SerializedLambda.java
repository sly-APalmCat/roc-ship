...
import com.rocship.aligenerator.localTest.AFunctionA;
...
public class SerializedLambda implements Serializable {
    ...
    public static SerializedLambda resolve(AFunctionA<?, ?> lambda) {
        ...
        try (ObjectInputStream objIn = new ObjectInputStream(new ByteArrayInputStream(SerializeUtils.serialize(lambda))) {
            @Override
    ...
    public Class getInstantiatedMethodType() {
        ...
        throw new IllegalArgumentException("无法从 %s 解析调用实例。。。");
    }
